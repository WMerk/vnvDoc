...
|----------		|:-------------:|
|Technique 		|  Execute each use-case scenario’s individual use-case flows or functions and features, 
...
Calabash can simulate all user interactions like clicks, swipes and more. |
